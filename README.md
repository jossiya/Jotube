...
>>🔥댓글 : 댓글 과 답글로 나누어 컨포넌트를 만들 었고, 댓글 작성자와 답글 작성자 id와 댓글 자체 개별 id를 만들고 videoid에 저장(DB에)하여 댓글들이 보이게 하였고 댓글에 단 답글은 코댓글 id를 이용하여 출력되게 했습니다. <b>videoid>commentid>responseTo</b><br/><br/> 
