...
전반적인 페이지를 만들 때 <b>프론트엔드 부분</b>은 리액트를 사용하고,
 ...
 <br/><br/>
 JavaScript로 공부를 하다가 최근 react를 많이 사용하고 처음 배우는 것은 어렵지만 사용할 줄 알면 많이 유용하다하여, 연습 프로젝트를 고민하던 중 yotube에 올라온 클론 페이지 사이트 만들기 영상을 보면서 만들게 되었고, 처음 만든 클론 사이트는 redux createStore로 만들었지만 권장되지 않는 다 하여 Redux Toolkit 으로 새로 만들게 되었습니다.
</p>
